...
const LoginPage: React.FC<IPropsLogin> = (props: IPropsLogin): JSX.Element => {
    ...
    return (
        <>
            ...
            <Button type='submit' sx={{fontFamily:'Poppins', marginTop: 2, marginBottom: 2, width: '50%'}} variant="contained">Войти</Button>
            <Typography variant='body1' sx={{fontFamily:'Poppins'}}>У вас нет аккаунта? <span className='insideRegText' onClick={() => navigate('/register')}>Регистрация</span></Typography>
        </>
    )
}
